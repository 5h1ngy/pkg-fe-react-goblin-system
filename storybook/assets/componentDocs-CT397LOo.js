import{j as i}from"./jsx-runtime-CDt2p4po.js";import{r as m}from"./index-GiUgBvb1.js";import{n as $n,d,l as w,S as In,b as Cn,e as Pn,f as qn,g as kn,h as Nn,i as An,A as Ln,E as zn,m as M,j as Rn}from"./icons-C2y5CVOK.js";import{r as jn}from"./index-CROobee-.js";const h=()=>$n(),Mn=["margin","marginTop","marginBottom","marginLeft","marginRight","marginInline","marginInlineStart","marginInlineEnd","marginBlock","marginBlockStart","marginBlockEnd","padding","paddingTop","paddingBottom","paddingLeft","paddingRight","paddingInline","paddingInlineStart","paddingInlineEnd","paddingBlock","paddingBlockStart","paddingBlockEnd","gap","columnGap","rowGap"],_n=(e,n)=>{const a={...e};return Mn.forEach(t=>{const r=a[t];typeof r=="number"&&(a[t]=n.spacing(r))}),a},X=e=>e?Array.isArray(e)?e.flatMap(n=>X(n)):[e]:[],b=(e,n,a)=>{const t=X(n).filter(Boolean);if(!t.length)return a;const r=t.reduce((o,s)=>{const l=typeof s=="function"?s(e):s;return{...o,..._n(l,e)}},{});return a?{...r,...a}:r},N=(...e)=>e.filter(Boolean),En=d.div``;function Bn({component:e,sx:n,style:a,...t},r){const o=e??"div",s=h(),l=b(s,n,a);return i.jsx(En,{as:o,ref:r,style:l,...t})}const U=m.forwardRef(Bn);U.displayName="Box";U.__docgenInfo={description:"",methods:[],displayName:"Box",props:{component:{required:!1,tsType:{name:"E"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""}}};const Gn=d.div`
  width: 100%;
`,Y=m.forwardRef(function({maxWidth:n="lg",disableGutters:a=!1,fixed:t=!1,sx:r,style:o,...s},l){const u=h(),p=n?`${u.breakpoints.values[n]}px`:void 0,c={width:"100%",marginInline:"auto",paddingInline:a?0:u.spacing(2),maxWidth:p?t?p:`min(${p}, 100%)`:void 0},f=b(u,N(c,r),o);return i.jsx(Gn,{ref:l,style:f,...s})});Y.displayName="Container";Y.__docgenInfo={description:"",methods:[],displayName:"Container",props:{component:{required:!1,tsType:{name:"E"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""},style:{required:!1,tsType:{name:"CSSProperties"},description:""},maxWidth:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg' | 'xl' | false",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"},{name:"literal",value:"'xl'"},{name:"literal",value:"false"}]},description:"",defaultValue:{value:"'lg'",computed:!1}},disableGutters:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},fixed:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}}}};const K=m.createContext({spacing:0,columns:12}),Vn=()=>m.useContext(K),Hn=d.div`
  ...
  ${({$sizes:e,$columns:n,theme:a})=>Object.entries(e).map(([t,r])=>{if(r===void 0||r===!1)return"";if(r==="auto"){const u=w`
        ...
        `;return t==="xs"?u:w`
            ...
            `}const s=`${(typeof r=="number"?Math.min(Math.max(r,0),n):n)/n*100}%`,l=w`
        flex-basis: ${s};
        max-width: ${s};
      `;return t==="xs"?l:w`
            ${a.breakpoints.up(t)} {
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["ButtonHTMLAttributes"]};const Zn=d(te)`
  ...
  padding: 0;
  border-radius: 50%;
`,ie=m.forwardRef(function({variant:n="text",color:a="primary",size:t="medium",disableElevation:r,sx:o,style:s,...l},u){const p=h(),c=b(p,N({width:40,height:40,borderRadius:"50%",padding:0},o),s);return i.jsx(Zn,{ref:u,$variant:n,$color:a,$size:t,$fullWidth:!1,$disableElevation:r,style:c,...l})});ie.displayName="IconButton";ie.__docgenInfo={description:"",methods:[],displayName:"IconButton",props:{variant:{required:!1,tsType:{name:"ButtonProps['variant']",raw:"ButtonProps['variant']"},description:"",defaultValue:{value:"'text'",computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| 'inherit'
| 'default'
| 'primary'
| 'secondary'
| 'success'
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const se=m.forwardRef(function({size:n="medium",sx:a,color:t="secondary",variant:r="contained",disableElevation:o,...s},l){const u=n==="small"?40:n==="large"?72:56,p={width:u,height:u,borderRadius:"50%",padding:0};return i.jsx(k,{ref:l,variant:r,color:t,disableElevation:o,size:n,sx:N(p,a),...s})});se.displayName="Fab";se.__docgenInfo={description:"",methods:[],displayName:"Fab",props:{variant:{required:!1,tsType:{name:"union",raw:"'text' | 'outlined' | 'contained'",elements:[{name:"literal",value:"'text'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'contained'"}]},description:"",defaultValue:{value:"'contained'",computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| 'inherit'
| 'default'
| 'primary'
| 'secondary'
| 'success'
...
`,le=({color:e="primary",size:n="medium",checked:a,disabled:t,onChange:r,indeterminate:o,inputProps:s})=>i.jsxs(_,{$size:n,$disabled:t,children:[i.jsx(ea,{$checked:o?!0:a,$color:e}),i.jsx(E,{type:"checkbox",checked:a,disabled:t,"aria-checked":o?"mixed":a,onChange:l=>r==null?void 0:r(l,l.target.checked),...s})]});le.displayName="Checkbox";le.__docgenInfo={description:"",methods:[],displayName:"Checkbox",props:{color:{required:!1,tsType:{name:"union",raw:`| 'inherit'
| 'default'
| 'primary'
| 'secondary'
| 'success'
...
`,de=({color:e="primary",size:n="medium",checked:a,disabled:t,onChange:r,inputProps:o,value:s,name:l})=>i.jsxs(_,{$size:n,$disabled:t,children:[i.jsx(na,{$checked:a,$color:e}),i.jsx(E,{type:"radio",checked:a,disabled:t,onChange:u=>r==null?void 0:r(u,u.target.checked),value:s,name:l,...o})]});de.displayName="Radio";de.__docgenInfo={description:"",methods:[],displayName:"Radio",props:{color:{required:!1,tsType:{name:"union",raw:`| 'inherit'
| 'default'
| 'primary'
| 'secondary'
| 'success'
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["Omit"]};const ye=m.forwardRef(function({selected:n,value:a,sx:t,...r},o){return i.jsx(k,{ref:o,"data-value":a,"aria-pressed":n,sx:N({borderRadius:"999px"},n?{backgroundColor:"rgba(0,0,0,0.08)"}:void 0,t),...r})});ye.displayName="ToggleButton";ye.__docgenInfo={description:"",methods:[],displayName:"ToggleButton",props:{selected:{required:!1,tsType:{name:"boolean"},description:""},value:{required:!0,tsType:{name:"string"},description:""}},composes:["Omit"]};const ve=({value:e,defaultValue:n,exclusive:a=!0,onChange:t,children:r,orientation:o="horizontal",sx:s,style:l,...u})=>{const p=h(),c=b(p,s,l),[f,y]=m.useState(n),g=e??f,T=(C,$)=>{if(a){y($),t==null||t(C,$);return}const v=Array.isArray(g)?g:[],S=v.includes($)?v.filter(P=>P!==$):[...v,$];y(S),t==null||t(C,S)},I=m.Children.map(r,C=>{if(!m.isValidElement(C))return C;const $=C.props.value,v=a?g===$:Array.isArray(g)&&g.includes($);return m.cloneElement(C,{selected:v,onClick:x=>T(x,$)})});return i.jsx(re,{$orientation:o,style:c,...u,children:I})};ve.displayName="ToggleButtonGroup";ve.__docgenInfo={description:"",methods:[],displayName:"ToggleButtonGroup",props:{value:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},defaultValue:{required:!1,tsType:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},description:""},exclusive:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"true",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent<HTMLElement>, value: string | string[]) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent<HTMLElement>",elements:[{name:"HTMLElement"}]},name:"event"},{type:{name:"union",raw:"string | string[]",elements:[{name:"string"},{name:"Array",elements:[{name:"string"}],raw:"string[]"}]},name:"value"}],return:{name:"void"}}},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:"",defaultValue:{value:"'horizontal'",computed:!1}},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["Omit"]};const sa=d.ul`
  list-style: none;
...
`,he=({options:e,onChange:n,sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t),[l,u]=m.useState(r.value??""),[p,c]=m.useState(!1),f=m.useMemo(()=>e.filter(g=>g.label.toLowerCase().includes(l.toLowerCase())),[e,l]),y=g=>{const T={target:{value:g.label}};u(g.label),c(!1),n==null||n(T,g)};return i.jsxs("div",{style:{position:"relative",...s},children:[i.jsx(B,{...r,value:l,onChange:g=>{const T=g;u(T.target.value),c(!0),n==null||n(T,null)},onFocus:()=>c(!0)}),p&&f.length>0&&i.jsx(sa,{children:f.map(g=>i.jsx("li",{onClick:()=>y(g),children:g.label},g.value))})]})};he.displayName="Autocomplete";he.__docgenInfo={description:"",methods:[],displayName:"Autocomplete",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"AutocompleteOption"}],raw:"AutocompleteOption[]"},description:""},value:{required:!1,tsType:{name:"string"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: ChangeEvent<HTMLInputElement>, value: AutocompleteOption | null) => void",signature:{arguments:[{type:{name:"ChangeEvent",elements:[{name:"HTMLInputElement"}],raw:"ChangeEvent<HTMLInputElement>"},name:"event"},{type:{name:"union",raw:"AutocompleteOption | null",elements:[{name:"AutocompleteOption"},{name:"null"}]},name:"value"}],return:{name:"void"}}},description:""}},composes:["Omit"]};const la=d.div`
  display: flex;
  gap: 1rem;
  align-items: center;
`,F=d.div`
...
`,be=({left:e,right:n,onChange:a,sx:t})=>{const r=h(),o=b(r,t),[s,l]=m.useState(e),[u,p]=m.useState(n),[c,f]=m.useState(new Set),[y,g]=m.useState(new Set),T=$=>{if($==="right"){const v=s.filter(P=>c.has(P.value)),x=s.filter(P=>!c.has(P.value)),S=[...u,...v];l(x),p(S),f(new Set),a==null||a(x,S)}else{const v=u.filter(P=>y.has(P.value)),x=u.filter(P=>!y.has(P.value)),S=[...s,...v];p(x),l(S),g(new Set),a==null||a(S,x)}},I=($,v,x)=>{const S=new Set($);S.has(x)?S.delete(x):S.add(x),v(S)},C=($,v,x)=>i.jsx("ul",{children:$.map(S=>i.jsx("li",{className:v.has(S.value)?"selected":void 0,onClick:()=>I(v,x,S.value),children:S.label},S.value))});return i.jsxs(la,{style:o,children:[i.jsxs(F,{children:[i.jsx("strong",{style:{padding:"0.5rem 0.75rem"},children:"Available"}),C(s,c,f)]}),i.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.5rem"},children:[i.jsx(k,{variant:"contained",onClick:()=>T("right"),children:">"}),i.jsx(k,{variant:"contained",onClick:()=>T("left"),children:"<"})]}),i.jsxs(F,{children:[i.jsx("strong",{style:{padding:"0.5rem 0.75rem"},children:"Chosen"}),C(u,y,g)]})]})};be.displayName="TransferList";be.__docgenInfo={description:"",methods:[],displayName:"TransferList",props:{left:{required:!0,tsType:{name:"Array",elements:[{name:"TransferListItem"}],raw:"TransferListItem[]"},description:""},right:{required:!0,tsType:{name:"Array",elements:[{name:"TransferListItem"}],raw:"TransferListItem[]"},description:""},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(left: TransferListItem[], right: TransferListItem[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"TransferListItem"}],raw:"TransferListItem[]"},name:"left"},{type:{name:"Array",elements:[{name:"TransferListItem"}],raw:"TransferListItem[]"},name:"right"}],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const ua=d.div`
  ...
  `}
`,xe=({disableGutters:e,children:n,sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t);return i.jsx(ua,{$disableGutters:e,style:s,...r,children:n})};xe.displayName="Toolbar";xe.__docgenInfo={description:"",methods:[],displayName:"Toolbar",props:{disableGutters:{required:!1,tsType:{name:"boolean"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,Ie=({label:e,value:n,icon:a,sx:t,style:r,...o})=>{const s=we(),l=h(),u=b(l,t,r),p=n??(e==null?void 0:e.toString())??"",c=s.value===p;return i.jsxs(pa,{type:"button",role:"tab","aria-selected":c,$selected:c,onClick:f=>s.onChange(f,p),style:u,...o,children:[a,e]})};Ie.displayName="Tab";Ie.__docgenInfo={description:"",methods:[],displayName:"Tab",props:{label:{required:!0,tsType:{name:"ReactNode"},description:""},value:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const fa=d.nav`
  ...
  align-items: center;
  font-size: 0.875rem;
`,ke=({separator:e="/",children:n,sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t),l=m.Children.toArray(n);return i.jsx(fa,{"aria-label":"breadcrumb",style:s,...r,children:l.map((u,p)=>i.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:"0.35rem"},children:[u,p<l.length-1&&i.jsx("span",{children:e})]},p))})};ke.displayName="Breadcrumbs";ke.__docgenInfo={description:"",methods:[],displayName:"Breadcrumbs",props:{separator:{required:!1,tsType:{name:"ReactNode"},description:"",defaultValue:{value:"'/'",computed:!1}},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,L=(e,n)=>Array.from({length:n-e+1},(a,t)=>e+t),Ne=({count:e,page:n,defaultPage:a=1,onChange:t,siblingCount:r=1,boundaryCount:o=1,sx:s,style:l,...u})=>{const[p,c]=m.useState(a),f=h(),y=b(f,s,l),g=n??p,T=(v,x)=>{c(x),t==null||t(v,x)},I=Math.max(Math.min(g-r,e-r*2-1),o+1),C=Math.min(Math.max(g+r,r*2+o+2),e-o),$=[...L(1,o),...I>o+1?["ellipsis-start"]:[],...L(I,C),...C<e-o?["ellipsis-end"]:[],...L(e-o+1,e)];return i.jsxs(ga,{role:"navigation",style:y,...u,children:[i.jsx(A,{type:"button","aria-label":"Previous page",disabled:g===1,onClick:v=>T(v,g-1),children:i.jsx(Pn,{size:18,"aria-hidden":!0})}),$.map((v,x)=>typeof v=="string"?i.jsx("span",{children:i.jsx(qn,{size:18,"aria-hidden":!0})},String(v)+"-"+x):i.jsx(A,{type:"button",$selected:v===g,"aria-current":v===g?"page":void 0,onClick:S=>T(S,v),children:v},"page-"+v)),i.jsx(A,{type:"button","aria-label":"Next page",disabled:g===e,onClick:v=>T(v,g+1),children:i.jsx(kn,{size:18,"aria-hidden":!0})})]})};Ne.displayName="Pagination";Ne.__docgenInfo={description:"",methods:[],displayName:"Pagination",props:{count:{required:!0,tsType:{name:"number"},description:""},page:{required:!1,tsType:{name:"number"},description:""},defaultPage:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.MouseEvent<HTMLButtonElement>, page: number) => void",signature:{arguments:[{type:{name:"ReactMouseEvent",raw:"React.MouseEvent<HTMLButtonElement>",elements:[{name:"HTMLButtonElement"}]},name:"event"},{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:""},siblingCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},boundaryCount:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"1",computed:!1}},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["Omit"]};const Ae=m.createContext(null),ya=()=>{const e=m.useContext(Ae);if(!e)throw new Error("BottomNavigationAction must be used within BottomNavigation");return e},va=d.nav`
  display: flex;
  align-items: center;
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["Omit"]};const ha=d.button`
  flex: 1;
  border: none;
  background: transparent;
  padding: 0.5rem;
...
`,ze=({label:e,icon:n,value:a,showLabel:t,...r})=>{const o=ya(),s=a??(e==null?void 0:e.toString())??"",l=o.value===s;return i.jsxs(ha,{type:"button",$selected:l,onClick:u=>o.onChange(u,s),...r,children:[n,(t||l)&&e]})};ze.displayName="BottomNavigationAction";ze.__docgenInfo={description:"",methods:[],displayName:"BottomNavigationAction",props:{label:{required:!1,tsType:{name:"ReactNode"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},value:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:""},showLabel:{required:!1,tsType:{name:"boolean"},description:""}},composes:["HTMLAttributes"]};const Re=m.createContext(null),ba=()=>{const e=m.useContext(Re);if(!e)throw new Error("Step components must be used within <Stepper>");return e},Sa=d.div`
  display: flex;
  gap: 1rem;
  position: relative;
  ${({$alternative:e})=>e&&w`
...
`,G=({children:e,optional:n,completed:a,active:t,icon:r,...o})=>{const s=a?i.jsx(Nn,{size:18,"aria-hidden":!0}):i.jsx(An,{size:18,"aria-hidden":!0});return i.jsxs(xa,{$completed:a,$active:t,...o,children:[i.jsx(Ta,{$completed:a,$active:t,children:r??s}),i.jsx("span",{children:e}),n&&i.jsx("small",{children:n})]})};G.displayName="StepLabel";G.__docgenInfo={description:"",methods:[],displayName:"StepLabel",props:{optional:{required:!1,tsType:{name:"ReactNode"},description:""},children:{required:!0,tsType:{name:"ReactNode"},description:""},completed:{required:!1,tsType:{name:"boolean"},description:""},active:{required:!1,tsType:{name:"boolean"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""}},composes:["HTMLAttributes"]};const wa=d.div`
  flex: 1;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Me=({index:e,completed:n,children:a,...t})=>{const r=ba(),o=r?r.activeStep===e:!1,s=n??(r?r.activeStep>e:!1),l=m.isValidElement(a)&&a.type===G?m.cloneElement(a,{completed:s,active:o}):a;return i.jsx(wa,{$completed:s,$active:o,...t,children:l})};Me.displayName="Step";Me.__docgenInfo={description:"",methods:[],displayName:"Step",props:{completed:{required:!1,tsType:{name:"boolean"},description:""},index:{required:!0,tsType:{name:"number"},description:""}},composes:["HTMLAttributes"]};const $a=d.a`
...
`,_e=({color:e="primary",underline:n="hover",sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t);return i.jsx($a,{$color:e,$underline:n,style:s,...r})};_e.displayName="Link";_e.__docgenInfo={description:"",methods:[],displayName:"Link",props:{color:{required:!1,tsType:{name:"union",raw:`| 'inherit'
| 'default'
| 'primary'
| 'secondary'
| 'success'
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["AnchorHTMLAttributes"]};const Ia=d.ul`
  ...
  z-index: ${({theme:e})=>e.zIndex.modal};
`,Ee=({anchorEl:e,open:n,onClose:a,children:t,sx:r,style:o,...s})=>{const[l,u]=m.useState({top:0,left:0}),p=h(),c=b(p,r,o);return m.useEffect(()=>{if(e&&n){const f=e.getBoundingClientRect();u({top:f.bottom+window.scrollY,left:f.left+window.scrollX})}},[e,n]),m.useEffect(()=>{const f=y=>{y.key==="Escape"&&(a==null||a())};return n&&window.addEventListener("keydown",f),()=>window.removeEventListener("keydown",f)},[n,a]),n?i.jsxs(i.Fragment,{children:[i.jsx(Pe,{onClick:a}),i.jsx(Ia,{role:"menu",style:{top:l.top,left:l.left,position:"absolute",...c},...s,children:t})]}):null};Ee.displayName="Menu";Ee.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{anchorEl:{required:!1,tsType:{name:"union",raw:"HTMLElement | null",elements:[{name:"HTMLElement"},{name:"null"}]},description:""},open:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""},as:{required:!1,tsType:{name:"ElementType"},description:""},raised:{required:!1,tsType:{name:"boolean"},description:""}},composes:["HTMLAttributes"]};const La=d.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing(2)};
`,za=La;za.displayName="CardContent";const Ra=d.div`
  display: flex;
...
`,We=({image:e,component:n="div",children:a,...t})=>{if(n==="img"||n==="video"){const r=n;return i.jsx(r,{src:e,style:{width:"100%",borderRadius:8,display:"block"},...t,...n==="video"?{controls:!0}:{}})}return i.jsx(Ma,{$image:e,...t,children:a})};We.displayName="CardMedia";We.__docgenInfo={description:"",methods:[],displayName:"CardMedia",props:{image:{required:!1,tsType:{name:"string"},description:""},component:{required:!1,tsType:{name:"union",raw:"'div' | 'img' | 'video'",elements:[{name:"literal",value:"'div'"},{name:"literal",value:"'img'"},{name:"literal",value:"'video'"}]},description:"",defaultValue:{value:"'div'",computed:!1}}},composes:["HTMLAttributes"]};const Fe=m.createContext(null),_a=()=>{const e=m.useContext(Fe);if(!e)throw new Error("Accordion subcomponents must be used within <Accordion>");return e},Ea=d.div`
  ...
  overflow: hidden;
  opacity: ${({$disabled:e})=>e?.6:1};
`,Xe=({expanded:e,defaultExpanded:n=!1,onChange:a,disabled:t,children:r,sx:o,style:s,...l})=>{const[u,p]=m.useState(n),c=e??u,f=h(),y=b(f,o,s),g=T=>{if(t)return;const I=!c;p(I),a==null||a(T,I)};return i.jsx(Fe.Provider,{value:{expanded:c,toggle:g},children:i.jsx(Ea,{$disabled:t,$expanded:c,style:y,...l,children:r})})};Xe.displayName="Accordion";Xe.__docgenInfo={description:"",methods:[],displayName:"Accordion",props:{expanded:{required:!1,tsType:{name:"boolean"},description:""},defaultExpanded:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: React.SyntheticEvent, expanded: boolean) => void",signature:{arguments:[{type:{name:"ReactSyntheticEvent",raw:"React.SyntheticEvent"},name:"event"},{type:{name:"boolean"},name:"expanded"}],return:{name:"void"}}},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,Ue=({expandIcon:e=i.jsx(zn,{}),children:n,...a})=>{const t=_a();return i.jsxs(Ba,{type:"button","aria-expanded":t.expanded,$expanded:t.expanded,onClick:r=>{r.preventDefault(),t.toggle(r)},...a,children:[i.jsx("span",{children:n}),i.jsx("span",{children:e})]})};Ue.displayName="AccordionSummary";Ue.__docgenInfo={description:"",methods:[],displayName:"AccordionSummary",props:{expandIcon:{required:!1,tsType:{name:"ReactNode"},description:"",defaultValue:{value:"<ExpandMoreIcon />",computed:!1}}},composes:["HTMLAttributes"]};const Ga=d.div`
  padding: ${({theme:e})=>`${e.spacing(.5)} ${e.spacing(2.6)} ${e.spacing(2.2)}`};
  color: ${({theme:e})=>e.palette.text.secondary};
`,Va=Ga;Va.displayName="AccordionDetails";const z=(e,n)=>e.palette[n],Ha=d.div`
  border-radius: ${({theme:e})=>e.shape.borderRadius}px;
  padding: 0.75rem 1rem;
  display: flex;
  align-items: center;
  gap: 0.75rem;
  border: 1px solid transparent;
  background: ${({theme:e,$severity:n,$variant:a})=>{const t=z(e,n);return a==="filled"?t.main:a==="outlined"?"transparent":`${t.main}22`}};
  color: ${({theme:e,$severity:n,$variant:a})=>{const t=z(e,n);return a==="filled"?t.contrastText:t.main}};
  border-color: ${({theme:e,$severity:n,$variant:a})=>a==="outlined"?z(e,n).main:"transparent"};
`,Ye=({severity:e="success",variant:n="standard",action:a,icon:t,onClose:r,children:o,sx:s,style:l,...u})=>{const p=h(),c=b(p,s,l);return i.jsxs(Ha,{$severity:e,$variant:n,role:"alert",style:c,...u,children:[t,i.jsx("div",{style:{flex:1},children:o}),a,r&&i.jsx("button",{onClick:r,style:{border:"none",background:"transparent",color:"inherit"}})]})};Ye.displayName="Alert";Ye.__docgenInfo={description:"",methods:[],displayName:"Alert",props:{severity:{required:!1,tsType:{name:"union",raw:"'success' | 'info' | 'warning' | 'error'",elements:[{name:"literal",value:"'success'"},{name:"literal",value:"'info'"},{name:"literal",value:"'warning'"},{name:"literal",value:"'error'"}]},description:"",defaultValue:{value:"'success'",computed:!1}},variant:{required:!1,tsType:{name:"union",raw:"'standard' | 'outlined' | 'filled'",elements:[{name:"literal",value:"'standard'"},{name:"literal",value:"'outlined'"},{name:"literal",value:"'filled'"}]},description:"",defaultValue:{value:"'standard'",computed:!1}},action:{required:!1,tsType:{name:"ReactNode"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,H=({open:e,children:n,sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t);return e?i.jsx(Da,{style:s,...r,children:n}):null};H.displayName="Backdrop";H.__docgenInfo={description:"",methods:[],displayName:"Backdrop",props:{open:{required:!0,tsType:{name:"boolean"},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,Ke=({open:e,onClose:n,fullWidth:a,maxWidth:t="sm",children:r,...o})=>e?i.jsx(H,{open:e,onClick:n,children:i.jsx(Oa,{$fullWidth:a,$maxWidth:t,onClick:s=>s.stopPropagation(),...o,children:r})}):null;Ke.displayName="Dialog";Ke.__docgenInfo={description:"",methods:[],displayName:"Dialog",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:""},maxWidth:{required:!1,tsType:{name:"union",raw:"'xs' | 'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'xs'"},{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},description:"",defaultValue:{value:"'sm'",computed:!1}}},composes:["HTMLAttributes"]};const Wa=d.h2`
  margin: 0;
  padding: ${({theme:e})=>`${e.spacing(2.2)} ${e.spacing(3)} ${e.spacing(1)}`};
  font-weight: ${({theme:e})=>e.typography.h6.fontWeight};
`,Fa=Wa;Fa.displayName="DialogTitle";const Xa=d.div`
  padding: ${({theme:e})=>`${e.spacing(2)} ${e.spacing(3)}`};
  flex: 1;
`,Ua=Xa;Ua.displayName="DialogContent";const Ya=d.div`
...
`,Ze=({variant:e="text",width:n,height:a,sx:t,style:r,...o})=>{const s=h(),l=b(s,t,r);return i.jsx(tt,{$variant:e,$width:n,$height:a,style:l,...o})};Ze.displayName="Skeleton";Ze.__docgenInfo={description:"",methods:[],displayName:"Skeleton",props:{variant:{required:!1,tsType:{name:"union",raw:"'text' | 'rectangular' | 'circular'",elements:[{name:"literal",value:"'text'"},{name:"literal",value:"'rectangular'"},{name:"literal",value:"'circular'"}]},description:"",defaultValue:{value:"'text'",computed:!1}},width:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},height:{required:!1,tsType:{name:"union",raw:"number | string",elements:[{name:"number"},{name:"string"}]},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
`,en=({open:e,message:n,autoHideDuration:a=4e3,onClose:t,action:r,anchorOrigin:o={vertical:"bottom",horizontal:"center"},...s})=>(m.useEffect(()=>{if(!e||!a)return;const l=setTimeout(()=>t==null?void 0:t(),a);return()=>clearTimeout(l)},[e,a,t]),e?i.jsxs(it,{role:"status",$anchor:o,...s,children:[i.jsx("span",{style:{flex:1},children:n}),r]}):null);en.displayName="Snackbar";en.__docgenInfo={description:"",methods:[],displayName:"Snackbar",props:{open:{required:!0,tsType:{name:"boolean"},description:""},message:{required:!0,tsType:{name:"ReactNode"},description:""},autoHideDuration:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"4000",computed:!1}},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},action:{required:!1,tsType:{name:"ReactNode"},description:""},anchorOrigin:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  vertical: 'top' | 'bottom'
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const st=d.span`
  position: relative;
  display: inline-flex;
`,lt=d.span`
  position: absolute;
...
`,on=({orientation:e="horizontal",flexItem:n,sx:a,style:t,...r})=>{const o=h(),s=b(o,a,t);return i.jsx(ut,{$orientation:e,$flex:n,style:s,...r})};on.displayName="Divider";on.__docgenInfo={description:"",methods:[],displayName:"Divider",props:{orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:"",defaultValue:{value:"'horizontal'",computed:!1}},flexItem:{required:!1,tsType:{name:"boolean"},description:""},textAlign:{required:!1,tsType:{name:"union",raw:"'left' | 'center' | 'right'",elements:[{name:"literal",value:"'left'"},{name:"literal",value:"'center'"},{name:"literal",value:"'right'"}]},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const mt=d.ul`
  ...
  margin: 0;
  padding: 0;
`,sn=e=>i.jsx(mt,{...e});sn.displayName="List";sn.__docgenInfo={description:"",methods:[],displayName:"List"};const pt=d.li`
  display: flex;
  align-items: center;
  gap: 0.75rem;
  padding: 0.75rem 1rem;
...
`,ln=({divider:e,button:n,...a})=>i.jsx(pt,{$divider:e,$button:n,...a});ln.displayName="ListItem";ln.__docgenInfo={description:"",methods:[],displayName:"ListItem",props:{divider:{required:!1,tsType:{name:"boolean"},description:""},button:{required:!1,tsType:{name:"boolean"},description:""}},composes:["HTMLAttributes"]};const ct=d.span`
  display: inline-flex;
  min-width: 32px;
  color: ${({theme:e})=>e.palette.text.secondary};
...
`,cn=({variant:e,...n})=>i.jsx(vt,{$variant:e,...n});cn.displayName="TableCell";cn.__docgenInfo={description:"",methods:[],displayName:"TableCell",props:{variant:{required:!1,tsType:{name:"union",raw:"'head' | 'body' | 'footer'",elements:[{name:"literal",value:"'head'"},{name:"literal",value:"'body'"},{name:"literal",value:"'footer'"}]},description:""}},composes:["HTMLAttributes"]};const ht=d.thead`
  background: ${({theme:e})=>e.palette.grey[100]};
`,fn=e=>i.jsx(ht,{...e});fn.displayName="TableHead";fn.__docgenInfo={description:"",methods:[],displayName:"TableHead"};const bt=d.tr`
  border-bottom: 1px solid ${({theme:e})=>e.palette.divider};
`,gn=e=>i.jsx(bt,{...e});gn.displayName="TableRow";gn.__docgenInfo={description:"",methods:[],displayName:"TableRow"};const St=d.span`
...
`,xt={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",subtitle1:"h6",subtitle2:"h6",body1:"p",body2:"p",button:"span",caption:"span",overline:"span"},yn=({variant:e="body1",color:n="initial",align:a="inherit",gutterBottom:t,paragraph:r,sx:o,style:s,component:l,children:u,...p})=>{const c=h(),f=b(c,o,s),y=m.useMemo(()=>l??xt[e]??"span",[l,e]);return i.jsx(St,{as:y,$variant:e,$color:n,$align:a,$gutter:t,$paragraph:r,style:f,...p,children:u})};yn.displayName="Typography";yn.__docgenInfo={description:"",methods:[],displayName:"Typography",props:{variant:{required:!1,tsType:{name:"union",raw:`| 'h1'
| 'h2'
| 'h3'
| 'h4'
| 'h5'
...
`,hn=({in:e=!1,timeout:n=300,children:a,sx:t,style:r,...o})=>{const s=m.useRef(null),[l,u]=m.useState(0),p=h(),c=b(p,t,r);return m.useEffect(()=>{s.current&&u(s.current.scrollHeight)},[a]),i.jsx(Tt,{$in:e,$height:l,$timeout:n,style:c,...o,children:i.jsx("div",{ref:s,children:a})})};hn.displayName="Collapse";hn.__docgenInfo={description:"",methods:[],displayName:"Collapse",props:{in:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},timeout:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"300",computed:!1}},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const D=({children:e,container:n})=>typeof document>"u"?null:jn.createPortal(e,n??document.body);D.displayName="Portal";const bn=d.div`
  position: fixed;
  inset: 0;
...
`,wt=d.div`
  ...
  max-height: 90vh;
  overflow: auto;
`,Sn=({open:e,onClose:n,children:a,sx:t,style:r,...o})=>{const s=h(),l=b(s,t,r);return e?i.jsx(D,{children:i.jsx(bn,{onClick:n,children:i.jsx(wt,{onClick:u=>u.stopPropagation(),style:l,...o,children:a})})}):null};Sn.displayName="Modal";Sn.__docgenInfo={description:"",methods:[],displayName:"Modal",props:{open:{required:!0,tsType:{name:"boolean"},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
...
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]}],raw:"SxInput[]"}]},description:""}},composes:["HTMLAttributes"]};const $t=d.div`
  ...
  z-index: ${({theme:e})=>e.zIndex.modal};
  min-width: 200px;
`,xn=({open:e,anchorEl:n,onClose:a,children:t,sx:r,style:o,...s})=>{const[l,u]=m.useState({top:0,left:0}),p=h(),c=b(p,r,o);return m.useEffect(()=>{if(n&&e){const f=n.getBoundingClientRect();u({top:f.bottom+window.scrollY,left:f.left+window.scrollX})}},[n,e]),e?i.jsx(D,{children:i.jsx(bn,{onClick:a,children:i.jsx($t,{onClick:f=>f.stopPropagation(),style:{top:l.top,left:l.left,position:"absolute",...c},...s,children:t})})}):null};xn.displayName="Popover";xn.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{open:{required:!0,tsType:{name:"boolean"},description:""},anchorEl:{required:!1,tsType:{name:"union",raw:"HTMLElement | null",elements:[{name:"HTMLElement"},{name:"null"}]},description:""},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},sx:{required:!1,tsType:{name:"union",raw:"SxInput | SxInput[]",elements:[{name:"union",raw:`| CSSProperties
| ((theme: GoblinTheme) => CSSProperties)
| false
| null
| undefined`,elements:[{name:"CSSProperties"},{name:"unknown"},{name:"literal",value:"false"},{name:"null"},{name:"undefined"}]},{name:"Array",elements:[{name:"union",raw:`| CSSProperties
