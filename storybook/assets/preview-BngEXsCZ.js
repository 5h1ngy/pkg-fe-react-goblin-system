import{j as l}from"./jsx-runtime-DiklIkkE.js";import{d as S}from"./index-DrFu-skq.js";import{r as f}from"./index-DRjF_FHU.js";import{f as b,o as _}from"./styled-components.browser.esm-Dz5yS7sT.js";import{l as k,d as z}from"./theme-_dwbflR3.js";const{useParameter:P,addons:w,useEffect:M,useMemo:K,definePreview:Y}=__STORYBOOK_MODULE_PREVIEW_API__,{deprecate:G}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var O=Object.defineProperty,v=(e,t)=>{for(var o in t)O(e,o,{get:t[o],enumerable:!0})},R={};v(R,{initialGlobals:()=>I});var p="themes",F=`storybook/${p}`,x="theme",y={},L={REGISTER_THEMES:`${F}/REGISTER_THEMES`},I={[x]:""},D={};v(D,{initializeThemeState:()=>T,pluckThemeFromContext:()=>E,useThemeParameters:()=>C});function E({globals:e}){return e[x]||""}function C(e){return G(S`The useThemeParameters function is deprecated. Please access parameters via the context directly instead e.g.
