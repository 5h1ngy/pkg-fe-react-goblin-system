...
import { chakra, useFieldContext, Box, useSlotRecipe, Span, useChakraContext, Spinner, Separator, useRecipe, IconButton, useBreakpointValue, Field as Field$2, Checkbox as Checkbox$1, VStack, Input as Input$2, Flex } from "@chakra-ui/react";
...
const s$1 = (t, s2, o2) => {
  ...
  for (const o2 in t.fields) {
    ...
    r2 && r2.ref && "reportValidity" in r2.ref ? s$1(r2.ref, o2, e) : r2 && r2.refs && r2.refs.forEach((t2) => s$1(t2, o2, e));
  }
}, r = (s2, r2) => {
  ...
  return f;
}, i$1 = (e, t) => e.some((e2) => e2.match(`^${t}\\.\\d+`));
var n = function(r2, e) {
  for (var n2 = {}; r2.length; ) {
    var s2 = r2[0], t = s2.code, i = s2.message, a = s2.path.join(".");
    ...
    if ("unionErrors" in s2 && s2.unionErrors.forEach(function(e2) {
      ...
      n2[a] = appendErrors(a, e, n2, t, f ? [].concat(f, s2.message) : s2.message);
    }
    r2.shift();
  }
  return n2;
  ...
  return void 0 === t && (t = {}), function(i, a, u) {
    try {
      return Promise.resolve(function(e, n2) {
        try {
          var a2 = Promise.resolve(o$1["sync" === t.mode ? "parse" : "parseAsync"](i, s2)).then(function(e2) {
...
function useNormalizeFields(schema, defaultValues) {
  ...
  const fields = schema.innerType().shape ? Object.entries(schema.innerType().shape).reduce((fields2, [name, fieldSchema]) => {
    var _a, _b, _c;
    const typedFieldSchema = fieldSchema;
    const step = ((_a = typedFieldSchema.meta) == null ? void 0 : _a.step) || 0;
    const key = ((_c = (_b = typedFieldSchema.meta) == null ? void 0 : _b.row) == null ? void 0 : _c.toString()) || "__NO_ROW__";
    const shape = [name, fieldSchema];
    if (!fields2[step]) {
      fields2[step] = {};
    }
    if (!fields2[step][`${key}`]) {
      fields2[step][`${key}`] = [shape];
    } else {
      const rowData = fields2[step][`${key}`];
      fields2[step][`${key}`] = [...rowData, shape];
    }
    return fields2;
  }, []) : [];
...
const getMaxStep = (schema) => {
  var _a;
  let maxStep = -Infinity;
  const schemaShape = schema.shape;
  for (const key in schemaShape) {
    const fieldMeta = (_a = schemaShape[key]) == null ? void 0 : _a.meta;
    if ((fieldMeta == null ? void 0 : fieldMeta.step) !== void 0 && (fieldMeta == null ? void 0 : fieldMeta.step) > maxStep) {
...
function _iterableToArrayLimit(r2, l) {
  ...
  if (null != t) {
    var e, n2, i, u, a = [], f = true, o2 = false;
    try {
...
function requireReactIs_production_min() {
  ...
  reactIs_production_min.isValidElementType = function(a) {
    return "string" === typeof a || "function" === typeof a || a === e || a === m || a === g || a === f || a === p || a === q || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r2 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n2 || a.$$typeof === w2 || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v);
  };
...
var cleanCommonProps$1 = function cleanCommonProps(props) {
  props.className;
  props.clearValue;
  props.cx;
  props.getStyles;
...
var IndicatorsContainer$1 = function IndicatorsContainer(props) {
...
var GroupHeading$1 = function GroupHeading(props) {
  var _cleanCommonProps = cleanCommonProps$1(props);
...
var Input$1 = function Input(props) {
  ...
  var _cleanCommonProps = cleanCommonProps$1(props), innerRef = _cleanCommonProps.innerRef, isDisabled = _cleanCommonProps.isDisabled, isHidden = _cleanCommonProps.isHidden, inputClassName = _cleanCommonProps.inputClassName, innerProps = _objectWithoutProperties(_cleanCommonProps, _excluded$5);
...
var MultiValueLabel$1 = MultiValueGeneric;
...
var MultiValue$1$1 = MultiValue$1;
...
var L = (e, r2, s2, u, d, m, l, h) => {
  ...
  if (u) p(u);
    ...
    let i = localStorage.getItem(r2) || s2, y = l && i === "system" ? a() : i;
    p(y);
  } catch (i) {
  }
};
var E = React.createContext(void 0), N = { setTheme: (e) => {
}, themes: [] }, z = () => {
  var e;
  return (e = React.useContext(E)) != null ? e : N;
};
React.memo(({ forcedTheme: e, storageKey: r2, attribute: s2, enableSystem: u, enableColorScheme: d, defaultTheme: m, value: l, themes: h, nonce: c, scriptProps: v }) => {
  let p = JSON.stringify([s2, r2, m, e, h, l, u, d]).slice(1, -1);
...
var _excluded$1 = ["allowCreateWhileLoading", "createOptionPosition", "formatCreateLabel", "isValidNewOption", "getNewOptionData", "onCreateOption", "options", "onChange"];
...
function useAsync(_ref3) {
  ...
  _ref3.options;
  var _ref$isLoading = _ref3.isLoading, propsIsLoading = _ref$isLoading === void 0 ? false : _ref$isLoading, propsOnInputChange = _ref3.onInputChange, _ref$filterOption = _ref3.filterOption, filterOption = _ref$filterOption === void 0 ? null : _ref$filterOption, restSelectProps = _objectWithoutProperties(_ref3, _excluded);
  var propsInputValue = restSelectProps.inputValue;
  var lastRequest = useRef(void 0);
  var mounted = useRef(false);
  var _useState = useState(Array.isArray(propsDefaultOptions) ? propsDefaultOptions : void 0), _useState2 = _slicedToArray(_useState, 2), defaultOptions2 = _useState2[0], setDefaultOptions = _useState2[1];
...
var SelectContainer2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.container) ? chakraStyles.container(initialCss, props) : initialCss;
...
var ValueContainer2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.valueContainer) ? chakraStyles.valueContainer(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var IndicatorsContainer2 = (props) => {
  const {
    children,
    className,
    cx,
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.indicatorsContainer) ? chakraStyles.indicatorsContainer(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var Svg2 = chakra("svg");
var CheckIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Svg2,
  {
    viewBox: "0 0 24 24",
    fill: "none",
...
var CloseIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Svg2, { viewBox: "0 0 24 24", fill: "currentColor", ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
  "path",
  {
    fillRule: "evenodd",
    clipRule: "evenodd",
...
var Control2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.control) ? chakraStyles.control(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ref: innerRef,
...
var IndicatorSeparator2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.indicatorSeparator) ? chakraStyles.indicatorSeparator(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Separator,
    {
...
var DropdownIndicator2 = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...
      children: children || /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDownIcon, { css: downChevronCss })
    }
  );
};
var ClearIndicator2 = (props) => {
  const {
    children,
    className,
    cx,
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.clearIndicator) ? chakraStyles.clearIndicator(initialCss, props) : initialCss;
    ...
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        IconButton,
        {
          ...
          pointerEvents: "auto",
          tabIndex: -1,
          children: children || /* @__PURE__ */ jsxRuntimeExports.jsx(CloseIcon, { css: iconCss })
        }
      )
    }
  );
};
var LoadingIndicator2 = (props) => {
  const {
    className,
    cx,
    innerProps,
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.loadingIndicator) ? chakraStyles.loadingIndicator(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Spinner,
    {
      className: cx(
...
var isSize = (size) => {
  const isString2 = typeof size === "string";
  return isString2 && ["sm", "md", "lg"].includes(size);
};
...
var Input2 = (props) => {
  ...
  const { innerRef, isDisabled, isHidden, inputClassName, ...innerProps } = cleanCommonProps2(props);
  const spacingCss = {
    gridArea: "1 / 2",
    minW: "2px",
    border: 0,
...
var Menu2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.menu) ? chakraStyles.menu(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var MenuList2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.menuList) ? chakraStyles.menuList(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var LoadingMessage2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.loadingMessage) ? chakraStyles.loadingMessage(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var NoOptionsMessage2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.noOptionsMessage) ? chakraStyles.noOptionsMessage(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var Group2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.group) ? chakraStyles.group(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { ...innerProps, className: cx({ group: true }, className), css: css4, children: [
...
var GroupHeading2 = (props) => {
  const {
    cx,
    className,
    selectProps: { chakraStyles, size, variant }
  } = props;
  const { data, ...innerProps } = cleanCommonProps2(props);
  const selectStyles = useSlotRecipe({ key: "select" })({ size, variant });
  const initialCss = {
    ...selectStyles.itemGroupLabel
  };
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.groupHeading) ? chakraStyles.groupHeading(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var MenuIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Span, { ...props, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) });
var Option2 = (props) => {
  const {
    className,
    cx,
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.option) ? chakraStyles.option(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box,
    {
      ...
      children: [
        children,
        showCheckIcon && /* @__PURE__ */ jsxRuntimeExports.jsx(MenuIcon, { css: { ...selectStyles.itemIndicator }, hidden: !isSelected, children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, {}) })
      ]
    }
  );
};
...
var MultiValue2 = (props) => {
  ...
  const {
    ...
    isDisabled,
    isFocused,
    removeProps: removeProps3,
    selectProps,
    cropWithEllipsis
  } = props;
  const { Container, Label, Remove } = components2;
...
var MultiValueContainer = (props) => {
  const { children, innerProps, css: css4 } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Span, { ...innerProps, css: css4, children });
};
...
var MultiValueRemove = (props) => {
  const { children, innerProps, isFocused, endElementCss, css: css4 } = props;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Span, { css: endElementCss, ...innerProps, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Span,
    {
      role: "button",
      css: css4,
...
var Placeholder2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.placeholder) ? chakraStyles.placeholder(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      ...innerProps,
...
var SingleValue2 = (props) => {
  ...
  const css4 = (chakraStyles == null ? void 0 : chakraStyles.singleValue) ? chakraStyles.singleValue(initialCss, props) : initialCss;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Box,
    {
      className: cx(
...
var chakraComponents = {
  ...
  IndicatorsContainer: IndicatorsContainer2,
  Input: Input2,
...
var Select = forwardRef(
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(StateManagedSelect$1, { ref, ...chakraSelectProps });
  }
);
...
forwardRef(
  (props, ref) => {
    const chakraSelectProps = use_chakra_select_props_default(props);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CreatableSelect$1, { ref, ...chakraSelectProps });
  }
);
forwardRef(
  (props, ref) => {
    const chakraSelectProps = use_chakra_select_props_default(props);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AsyncSelect$1, { ref, ...chakraSelectProps });
  }
);
forwardRef(
  (props, ref) => {
    const chakraSelectProps = use_chakra_select_props_default(props);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(AsyncCreatableSelect$1, { ref, ...chakraSelectProps });
  }
);
const Field$1 = forwardRef(
  function Field2(props, ref) {
    const { label, children, helperText, errorText, optionalText, ...rest } = props;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Field$2.Root, { ref, ...rest, children: [
      label && /* @__PURE__ */ jsxRuntimeExports.jsxs(Field$2.Label, { children: [
        label,
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field$2.RequiredIndicator, { fallback: optionalText })
      ] }),
      children,
      helperText && /* @__PURE__ */ jsxRuntimeExports.jsx(Field$2.HelperText, { children: helperText }),
      errorText && /* @__PURE__ */ jsxRuntimeExports.jsx(Field$2.ErrorText, { children: errorText })
    ] });
  }
);
...
function Field({ methods, name, meta, fieldSchema }) {
  const baseSchema = getBaseType(fieldSchema);
  function checkInputType(key) {
    if (baseSchema instanceof z$1.ZodString && key.toLowerCase().includes("password")) {
      return "password";
    } else if (baseSchema instanceof z$1.ZodString && key.toLowerCase().includes("email")) {
      return "email";
    } else if (baseSchema instanceof z$1.ZodDate) {
      return "date";
    } else {
      return "text";
    }
    ...
    if (baseSchema instanceof z$1.ZodString || baseSchema instanceof z$1.ZodDate) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(VStack, { ...!(meta == null ? void 0 : meta.style) ? { width: "100%" } : { ...meta == null ? void 0 : meta.style }, alignItems: "left", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Field$1,
        {
          ...
          invalid: methods.formState.errors[name] !== void 0,
          errorText: (_a = methods.formState.errors[name]) == null ? void 0 : _a.message,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input$2,
            {
              ...
              id: name,
              name,
              autoComplete: (meta == null ? void 0 : meta.autocomplete) ?? "",
              onBlur: field.onBlur,
      ...
      const zodSchemaEnum = baseSchema;
      const options2 = zodSchemaEnum.options.map((value, index2) => {
        var _a2;
        return {
          label: ((_a2 = meta == null ? void 0 : meta.labels) == null ? void 0 : _a2[index2]) ?? "",
          value: value ?? null
        };
      });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        Field$1,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            select_default,
            {
              ...field,
              options: options2,
              value: options2.find((option) => option.value === field.value) || null,
              onChange: (selectedOption) => field.onChange(selectedOption ? selectedOption.value : null),
              placeholder: (meta == null ? void 0 : meta.label) ? `Select ${meta == null ? void 0 : meta.label}` : void 0,
              defaultValue: null
            }
          )
        }
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          invalid: methods.formState.errors[name] !== void 0,
          errorText: (_b = methods.formState.errors[name]) == null ? void 0 : _b.message,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Checkbox,
            {
              ...field,
...
function DynamicForm({
  ...
  const stepFields = fields.length !== 0 ? Object.entries(fields[step] ?? {}).flatMap(([_, fieldArray]) => fieldArray.map(([fieldName]) => fieldName)) : [];
  const rows = fields.length !== 0 ? Object.entries(fields[step] ?? {}).map(([key, value]) => {
    switch (key) {
      case "__NO_ROW__": {
        return value.map(([name, fieldSchema]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Field,
          {
            methods,
            name,
            meta: fieldSchema.meta ?? void 0,
            fieldSchema
          },
          crypto.randomUUID()
        ));
  ...
  async function next2() {
    const isValid2 = await methods.trigger(stepFields);
    if (isValid2) {
      const maxStep = getMaxStep(schema.innerType());
      const nextStep = step + 1;
      nextStep <= maxStep ? nextStep === maxStep ? onNext(nextStep, true) : onNext(nextStep, false) : onNext(nextStep, false);
    }
  }
  async function back() {
    const maxStep = getMaxStep(schema.innerType()) + 1;
    const nextStep = step - 1;
    nextStep <= maxStep && nextStep >= 0 ? nextStep !== maxStep ? onBack(nextStep, false) : onBack(nextStep, false) : onBack(nextStep, false);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Flex, { flexDirection: "column", width, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormProvider, { ...methods, children: render ? render(rows, methods.handleSubmit, next2, back) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    rows,
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Invia" })
  ] }) }) });
}
export {
