...
const html$2 = merge([xml$1, xlink, xmlns, aria, html$3], "html");
...
const StyledMarkdown = ({ content: content2 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "markdown-container", children: [
    " ",
