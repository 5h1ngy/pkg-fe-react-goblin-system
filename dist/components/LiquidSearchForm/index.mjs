      ...
      render: (fields) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Stack,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { width: "fit-content", height: "full", alignItems: "end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", type: "submit", colorPalette: "teal", width: "fit-content", marginTop: "20px", children: "Crea Account" }) })
          ]
        }
      )
    }
