...
function withContext(WrappedComponent) {
  const HOC = (props) => {
    ...
    }, [(_a = props == null ? void 0 : props.location) == null ? void 0 : _a.pathname]);
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap, _coreInitted, _window, _docEl, _body, _toArray, _config, ScrollTrigger, _windowExists3 = function _windowExists4() {
  return typeof window !== "undefined";
  ...
  _isFunction2(value) && (value = value(index2, target, targets));
  if (typeof value !== "object") {
    ...
    var result = {}, p;
    for (p in value) {
      result[p] = p !== "onAutoKill" && _isFunction2(value[p]) ? value[p](index2, target, targets) : value[p];
    }
    return result;
  }
  ...
  gsap = _getGSAP();
  if (_windowExists3() && gsap && typeof document !== "undefined" && document.body) {
    _window = window;
    _body = document.body;
...
ScrollToPlugin.config = function(vars) {
  _config || _initCore2() || (_config = gsap.config());
  for (var p in vars) {
    _config[p] = vars[p];
  }
};
...
const usePageContext = () => {
  const context3 = useContext(Context$1);
  if (!context3) {
        ...
        navbarSubItems && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Flex,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Tabs.Root,
              {
                defaultValue: props.location ? findMatchingNavbarValue(props.location.pathname, navbarItems, navbarSubItems) : "",
                variant: "line",
                size: "sm",
                onValueChange: (details) => {
                  if (props.navigate) props.navigate(details.value);
                },
                  ...
                  (subItem) => {
                    ...
                    return subItem.group ? (_b = subItem.group) == null ? void 0 : _b.includes(
                      ((_a = navbarItems == null ? void 0 : navbarItems.find(
                        (item) => {
                          var _a2;
                          return ((_a2 = props.location) == null ? void 0 : _a2.pathname.search(new RegExp(item.value, "g"))) !== -1;
                        }
      ...
      children: [
        background && /* @__PURE__ */ jsxRuntimeExports.jsx(
          chakra.div,
          {
            ...
            backgroundImage: background.image ? `url(${background.image})` : void 0,
            _dark: {
              backgroundColor: "gray.950",
              backgroundImage: background.imageDark ? `url(${background.imageDark})` : void 0
            }
          }
        ),
