...
export declare const TimelineRoot: import("react").ForwardRefExoticComponent<ChakraTimeline.RootProps & import("react").RefAttributes<HTMLDivElement>>;
export declare const TimelineContent: import("react").ForwardRefExoticComponent<ChakraTimeline.ContentProps & import("react").RefAttributes<HTMLDivElement>>;
export declare const TimelineItem: import("react").ForwardRefExoticComponent<ChakraTimeline.ItemProps & import("react").RefAttributes<HTMLDivElement>>;
