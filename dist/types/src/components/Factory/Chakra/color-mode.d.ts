...
export declare function ColorModeProvider(props: ColorModeProviderProps): import("react").JSX.Element;
...
export declare function ColorModeIcon(): import("react").JSX.Element;
...
export declare const ColorModeButtonExtended: (props: ColorModeButtonExtendedProps) => import("react").JSX.Element;
