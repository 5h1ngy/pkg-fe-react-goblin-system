...
export declare const StepsItem: (props: StepsItemProps) => import("react/jsx-runtime").JSX.Element;
interface StepsIndicatorProps {
    completedIcon: React.ReactNode;
    icon?: React.ReactNode;
}
export declare const StepsIndicator: (props: StepsIndicatorProps) => import("react/jsx-runtime").JSX.Element;
...
export declare const StepsNextTrigger: (props: ChakraSteps.NextTriggerProps) => import("react/jsx-runtime").JSX.Element;
export declare const StepsPrevTrigger: (props: ChakraSteps.PrevTriggerProps) => import("react/jsx-runtime").JSX.Element;
export {};
